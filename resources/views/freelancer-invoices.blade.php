						...
						<div class="col-xl-9 col-md-8">
							<nav class="user-tabs mb-4">
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
									<li class="nav-item">
										<a class="nav-link" href="freelancer-withdraw-money">Withdraw Funds</a>
									</li>
									<li class="nav-item">
										<a class="nav-link active" href="freelancer-invoices"> Invoices</a>
									</li>
									<li class="nav-item">
