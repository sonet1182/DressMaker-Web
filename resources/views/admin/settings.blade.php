                                        ...
                                        <div class="settings-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="upload-images">
                                                    <img id="prev_logo"
                                                        src="{{ $web->logo ? asset($web->logo) : '../assets_admin/img/logo.png' }}"
                                                        alt="Image">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body pt-0">
                                    ...
                                    <form action="{{ route('admin.update_web_address') }}" enctype="multipart/form-data"
                                        method="post">
                                        @csrf
                                        <div class="settings-form">
                                            <div class="form-group">
                                                <label>Address Line 1 <span class="star-red">*</span></label>
                                                <input type="text" name="address1" value="{{ $web->address1 }}"
                                                    class="form-control" placeholder="Enter Address Line 1">
                                            </div>
                                            <div class="form-group">
                                                <label>Address Line 2 <span class="star-red">*</span></label>
                                                <input type="text" name="address2" value="{{ $web->address2 }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="city" value="{{ $web->city }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                        ...
                                                        <select class="select form-control" name="country">
                                                            ...
                                                            @foreach ($countries as $country)
                                                                <option value="{{ $country->name }}"
                                                                    {{ $country->name == $web->country ? 'selected' : '' }}>
                                                                    {{ $country->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
